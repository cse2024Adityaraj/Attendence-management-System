...
public class MainWindow implements ActionListener {
        ...
        try {
        	...
        	validConnection=false;
                try {
    				...
    				// TODO Auto-generated catch block
    				//e2.printStackTrace();
                	lblUstawieniaZapisanoPomylnie.setText("Niepoprawne dane wejciowe. Sprawd poprawnoæ wpisanych wartoci.");
        	...
        	if(!czytanieUruchomione)
        	{
        		...
        		trayIcon.setToolTip("Klient obecnoci [aktywny]");
        	...
        	else
        	{
        		...
        		trayIcon.setToolTip("Klient obecnoci [nieaktywny]");
	...
	public boolean getServerResponse(String uid,String sala)
	{
        ...
        if (clientSocket != null && os != null && is != null) {
        	...
        	if(uid.length()==0)
        	{
        		// pseudoconsoleWrite("Wpisz poprawn¹ wartoæ UID");
	...
	private void initialize() {
       ...
       /* quickSettingsMenu.add(errorItem);
        ...
        exitItem.addActionListener(new ActionListener() {
			...
			"Czy na pewno chcesz wyjæ z programu?",
			"Klient obecnoci",
